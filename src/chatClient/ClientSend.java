...
public class ClientSend extends JFrame implements ActionListener, KeyListener {
   ...
   private void main_init() {
      ...
      joinroom_btn.setEnabled(false);    //9820
